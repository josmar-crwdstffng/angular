...
For example, [Material Design](https://material.angular.io/components/button/overview) uses this technique with the `mat-button` attribute of the `button` element.
