...
The **Profiler** tab lets you preview the execution of change detection in Angular.
...
### Understand the execution of your application
...
For example, if during one change detection cycle at a specific position in the component tree you had `ComponentA`, this component was removed and Angular replaced and rendered `ComponentB`, you will see both components at the same tile.
