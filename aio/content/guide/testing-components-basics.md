...
Then exercise the component class, remembering to call the [lifecycle hook methods][AioGuideComponentUseLifecycleHooks] as Angular does when running the application.
