...
The Angular template compiler also generates `$localize` tagged strings rather than doing the translation.
...
This means that after the Angular compiler has completed the associated work, all the template text marked with `i18n`
