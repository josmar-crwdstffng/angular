  ...
  describe('InPlaceFileWriter', () => {
    ...
    beforeEach(() => {
      ...
      loadTestFiles([
        ...
        {name: _('/package/path/directory-1/file-1.js'), contents: 'ORIGINAL FILE 1'},
        {name: _('/package/path/directory-1/file-2.js'), contents: 'ORIGINAL FILE 2'},
        {name: _('/package/path/directory-2/file-3.js'), contents: 'ORIGINAL FILE 3'},
        {name: _('/package/path/directory-2/file-4.js'), contents: 'ORIGINAL FILE 4'},
    ...
    describe('writeBundle()', () => {
      it('should write all the FileInfo to the disk', () => {
        ...
        fileWriter.writeBundle({} as EntryPointBundle, [
          ...
          {path: _('/package/path/directory-1/file-1.js'), contents: 'MODIFIED FILE 1'},
          {path: _('/package/path/directory-2/file-4.js'), contents: 'MODIFIED FILE 4'},
          {path: _('/package/path/directory-3/file-5.js'), contents: 'NEW FILE 5'},
        ]);
        expect(fs.readFile(_('/package/path/top-level.js'))).toEqual('MODIFIED TOP LEVEL');
        expect(fs.readFile(_('/package/path/directory-1/file-1.js'))).toEqual('MODIFIED FILE 1');
        expect(fs.readFile(_('/package/path/directory-1/file-2.js'))).toEqual('ORIGINAL FILE 2');
        expect(fs.readFile(_('/package/path/directory-2/file-3.js'))).toEqual('ORIGINAL FILE 3');
        expect(fs.readFile(_('/package/path/directory-2/file-4.js'))).toEqual('MODIFIED FILE 4');
        expect(fs.readFile(_('/package/path/directory-3/file-5.js'))).toEqual('NEW FILE 5');
      });
      ...
      it('should create backups of all files that previously existed', () => {
        ...
        expect(fs.readFile(_('/package/path/directory-1/file-1.js.__ivy_ngcc_bak')))
            .toEqual('ORIGINAL FILE 1');
        expect(fs.exists(_('/package/path/directory-1/file-2.js.__ivy_ngcc_bak'))).toBe(false);
        expect(fs.exists(_('/package/path/directory-2/file-3.js.__ivy_ngcc_bak'))).toBe(false);
        expect(fs.readFile(_('/package/path/directory-2/file-4.js.__ivy_ngcc_bak')))
            .toEqual('ORIGINAL FILE 4');
        expect(fs.exists(_('/package/path/directory-3/file-5.js.__ivy_ngcc_bak'))).toBe(false);
      });
    ...
    describe('revertBundle()', () => {
      it('should revert the written files (and their backups)', () => {
        ...
        const filePath1 = _('/package/path/directory-1/file-1.js');
        const filePath2 = _('/package/path/directory-1/file-2.js');
        const fileBackupPath1 = _(`/package/path/directory-1/file-1.js${NGCC_BACKUP_EXTENSION}`);
        const fileBackupPath2 = _(`/package/path/directory-1/file-2.js${NGCC_BACKUP_EXTENSION}`);
      ...
      it('should just remove the written files if there is no backup', () => {
        ...
        const filePath = _('/package/path/directory-1/file-1.js');
        const fileBackupPath = _(`/package/path/directory-1/file-1.js${NGCC_BACKUP_EXTENSION}`);
